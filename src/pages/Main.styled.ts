...
export const Wrapper = styled.main`
  ...
  ${({ theme }) =>
    `background-image: url("data:image/svg+xml,%3Csvg version='1.1' id='Layer_1' xmlns:rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns%23' xmlns:cc='http://creativecommons.org/ns%23' xmlns:dc='http://purl.org/dc/elements/1.1/' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' width='148px' height='148px' viewBox='0 0 24 24' %3E%3Cg transform='translate(0 -1028.4)'%3E%3Cpath fill='%23${theme.colors.backgroundDark.replace(
      '#',
      '',
